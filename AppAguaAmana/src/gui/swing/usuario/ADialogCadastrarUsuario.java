...
public class ADialogCadastrarUsuario extends JDialog implements EspectadorCadastrarUsuario {
	...
	private void initComponents(){
		...
		painelTopo = new APanelTopo("Usuário", "Cadastrar", "imagens/32x32/usuario_add.png");
		...
		lblUsuario = new JLabel("Usuário (Min: 4 caracteres)");
		...
		btnCadastrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				&& jUsuarioTextField.isValido() && jSenhaTextField.isValido()){
						...
						if(apresentador.existeUsuario()){
	                		...
	                		if (s != null) {
	                			if(apresentador.cadastrar()){
                            		novoUsuario = true;
	                				JOptionPane.showMessageDialog(null, "Usuário cadastrado com sucesso.", "Cadastrar Usuário", JOptionPane.INFORMATION_MESSAGE);      
                            		setVisible(false);
                    				apresentador = null;
                            		removeAll();
                    				dispose();
					...
					JOptionPane.showMessageDialog(null, "Preencha corretamente todos os campos obrigatórios.", "Cadastrar Usuário", JOptionPane.ERROR_MESSAGE);
                }
			}
		});
