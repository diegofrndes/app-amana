...
public class APanelPatrimonio extends JPanel implements EspectadorPanelPatrimonio {
	...
	private void initComponents(){
		...
		botaoDescricao = new JToggleButton("Descrição");
		...
		labelMenu = new JLabel("Menu Patrimônio");
	                ...
	                if (j == JOptionPane.YES_OPTION) {
	                	try{
	                		...
	                		if(apresentador.desativar(modelo.getPatrimonio(painelTabela.getTabela().getSelectedRow()))){
	                			JOptionPane.showMessageDialog(null, "Bem patrimonial excluído com sucesso.", "Excluir Bem Patrimonial", JOptionPane.INFORMATION_MESSAGE);      
	                			buscar();
	                		}
	                		else{
	                			JOptionPane.showMessageDialog(null, "Não foi possível excluir o bem patrimonial.", "Excluir Bem Patrimonial", JOptionPane.ERROR_MESSAGE );
	                		}
	                	}
	                	catch (Exception e) {
	                		JOptionPane.showMessageDialog(null, "Não foi possível excluir o bem patrimonial.", "Excluir Bem Patrimonial", JOptionPane.ERROR_MESSAGE );
