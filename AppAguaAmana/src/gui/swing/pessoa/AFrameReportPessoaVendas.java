...
public class AFrameReportPessoaVendas  extends JFrame {
	...
	public AFrameReportPessoaVendas(int id, String data_inicial, String data_final) {
		this.id = id;
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/cliente_amana_vendas.jasper", parametros, FabricaConexao.getConexao());
