				...
				if(painelDados.isValido() && painelEndereco.isValido()){
					try{
						if(apresentador.cadastrar()){
							novoCliente = true;
	                		JOptionPane.showMessageDialog(null, "Pessoa Física cadastrada com sucesso.", "Cadastrar Pessoa Física", JOptionPane.INFORMATION_MESSAGE);      
                            setVisible(false);
                    		apresentador = null;
                            removeAll();
                    		dispose();
                        	...
                        	JOptionPane.showMessageDialog(null, "Erro ao tentar cadastrar pessoa física.\n", "Cadastrar Pessoa Física", JOptionPane.ERROR_MESSAGE );    
                        }
					...
					JOptionPane.showMessageDialog(null, "Preencha corretamente todos os campos obrigatórios.", "Cadastrar Pessoa Física", JOptionPane.ERROR_MESSAGE);
                }
			}
		});
