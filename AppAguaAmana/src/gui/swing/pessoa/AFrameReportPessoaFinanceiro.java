...
public class AFrameReportPessoaFinanceiro  extends JFrame {
	...
	public AFrameReportPessoaFinanceiro(int id, String data_inicial, String data_final) {
		this.id = id;
		this.data_final = data_final;
		this.data_inicial = data_inicial;
		setTitle("Relatório de Cliente (Financeiro)");
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/cliente_financeiro_amana.jasper", parametros, FabricaConexao.getConexao());
