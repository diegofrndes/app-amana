...
public class AFrameReportPessoaProdutos  extends JFrame {
	...
	public AFrameReportPessoaProdutos(int id, String data_inicial, String data_final) {
		this.id = id;
		this.data_final = data_final;
		this.data_inicial = data_inicial;
		setTitle("Relatório de Cliente (Produtos)");
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/cliente_amana_produtos.jasper", parametros, FabricaConexao.getConexao());
