...
public class AFrameReportVendasAmanaResumido extends JFrame {
	...
	public AFrameReportVendasAmanaResumido(String data_inicial, String data_final) {
		setTitle("Relatório de Vendas Consolidados");
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/vendas_amana_resumido.jasper", parametros, FabricaConexao.getConexao());
