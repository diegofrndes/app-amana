...
public class AFrameReportFinanceiroAmanaResumido extends JFrame {
	...
	public AFrameReportFinanceiroAmanaResumido(String data_inicial, String data_final) {
		setTitle("Relatório Financeiro (Consolidado)");
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/financeiro_amana_resumido.jasper", parametros, FabricaConexao.getConexao());
