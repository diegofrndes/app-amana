...
public class AFrameReportVendasAmana extends JFrame {
	...
	public AFrameReportVendasAmana(String data_inicial, String data_final) {
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/vendas_amana.jasper", parametros, FabricaConexao.getConexao());
