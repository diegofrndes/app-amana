...
public class AFrameReportPagamentosAmanaResumido extends JFrame {
	...
	public AFrameReportPagamentosAmanaResumido(String data_inicial, String data_final) {
		setTitle("Relatório de Pagamentos Consolidados");
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/pagamentos_amana_resumido.jasper", parametros, FabricaConexao.getConexao());
