...
public class AFrameReportFinanceiroAmana extends JFrame {
	...
	public AFrameReportFinanceiroAmana(String data_inicial, String data_final) {
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/financeiro_amana.jasper", parametros, FabricaConexao.getConexao());
