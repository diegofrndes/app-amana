...
public class AFrameReportTicket extends JFrame {
	...
	public AFrameReportTicket(String data_inicial, String data_final) {
		setTitle("Relatório Ticket Médio");
	...
	public void initComponents(){
		try {
			...
			try {
				...
				e.printStackTrace();
				JOptionPane.showMessageDialog(null, "Não foi possível gerar o relatório.", FabricaConexao.getApelido(), JOptionPane.ERROR_MESSAGE);
				dispose();
			}
			...
			print = JasperFillManager.fillReport("./relatorios-src/ticket_medio.jasper", parametros, FabricaConexao.getConexao());
