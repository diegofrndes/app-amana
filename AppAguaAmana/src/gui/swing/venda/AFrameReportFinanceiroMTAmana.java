...
public class AFrameReportFinanceiroMTAmana extends JFrame {
	...
	public AFrameReportFinanceiroMTAmana(String data_inicial, String data_final) {
		setTitle("Relatório Financeiro M/T");
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/financeiro_amana_mt.jasper", parametros, FabricaConexao.getConexao());
