...
public class ADialogRelatorioProdutoRanking extends JDialog {
	...
	public ADialogRelatorioProdutoRanking(Produto produto) {
		this.produto = produto;
		setTitle("Relatório de Rankind=g de " + produto.getNome());
		...
		botaoRelatorio.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					new AFrameReportProdutoRanking(produto.getId(), dataInicial
