...
public class AFrameReportProdutoCliente extends JFrame {
	...
	public AFrameReportProdutoCliente(String data_inicial, String data_final) {
		setTitle("Relatório de Produto Cliente");
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/produtos_clientes.jasper", parametros, FabricaConexao.getConexao());
