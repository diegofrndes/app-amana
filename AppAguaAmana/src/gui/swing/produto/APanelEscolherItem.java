...
public class APanelEscolherItem extends JPanel implements EspectadorPanelItem {
	...
	private ADialogEscolherItem tela;
	
	public APanelEscolherItem(ADialogEscolherItem tela)
	{
		this.tela = tela;
		initComponents();
	...
	public void buscar(){
		try{
			...
			else if(list.getSelectedValue().toString().equals("Limite Crítico Alcançado")){
	...
	private void initComponents(){
		...
		model.addElement("Limite Crítico Alcançado");
		...
		botaoEscolher.addActionListener(new ActionListener() {	
			...
			public void actionPerformed(ActionEvent arg0) {
        		...
        		tela.setEscolhido(modelo.getItem(painelTabela.getTabela().getSelectedRow())); 
		...
		lblQuant = new JLabel("Quantidade De Itens No Produto: ");
		jSpinnerQuant = new JSpinner(new SpinnerNumberModel(1,1,1000, 1));
	...
	public void setModelo(ModeloTabelaItem model) {
        ...
        columnModel.getColumn(2).setHeaderValue("Limite Crítico");
	...
	private class ImagensProduto extends JLabel implements ListCellRenderer{
	    ...
	    public Component getListCellRendererComponent(
	      ...
	      else if(value.toString() == "Limite Crítico Alcançado"){
