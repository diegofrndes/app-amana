...
public class AFrameReportProdutoRanking  extends JFrame {
	...
	public AFrameReportProdutoRanking(int id, String data_inicial, String data_final) {
		this.id = id;
		this.data_final = data_final;
		this.data_inicial = data_inicial;
		setTitle("Relatório de Ranking de Produtos");
	...
	public void initComponents(){
		try {
			...
			parametros.put("IDPRODUTO", id);
			parametros.put("DATA_INICIAL", time_inicial);
			parametros.put("DATA_FINAL", time_final);
			
			print = JasperFillManager.fillReport("./relatorios-src/produtos_ranking.jasper", parametros, FabricaConexao.getConexao());
            viewer = new JRViewer(print);
            add(viewer);
            pack();
		} catch (JRException e) {
			JOptionPane.showMessageDialog(null, "Não foi possível gerar relatório de produto.", FabricaConexao.getApelido(), JOptionPane.ERROR_MESSAGE);
			dispose();
		}
	}
}
