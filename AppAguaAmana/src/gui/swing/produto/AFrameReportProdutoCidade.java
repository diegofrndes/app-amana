...
public class AFrameReportProdutoCidade extends JFrame {
	...
	public AFrameReportProdutoCidade(String data_inicial, String data_final) {
		setTitle("Relatório de Produto Cidade");
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/produtos_cidade.jasper", parametros, FabricaConexao.getConexao());
