...
public class AFrameReportProduto  extends JFrame {
	...
	public AFrameReportProduto(int id, String data_inicial, String data_final) {
		this.id = id;
	...
	public void initComponents(){
		try {
			...
			print = JasperFillManager.fillReport("./relatorios-src/produtos_amana.jasper", parametros, FabricaConexao.getConexao());
