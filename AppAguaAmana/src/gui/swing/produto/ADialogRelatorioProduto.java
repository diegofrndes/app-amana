...
public class ADialogRelatorioProduto extends JDialog {
	...
	public ADialogRelatorioProduto(Produto produto) {
		this.produto = produto;
		setTitle("Relatório de " + produto.getNome());
		...
		botaoRelatorio.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					new AFrameReportProduto(produto.getId(), dataInicial
